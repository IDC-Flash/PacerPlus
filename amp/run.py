...
def main():
    ...
    flags.debug, flags.follow, flags.fixed, flags.divide_group, flags.no_collision_check, flags.fixed_path, flags.real_path, flags.small_terrain, flags.show_traj, flags.show_im, flags.server_mode, flags.slow, flags.height_debug, flags.random_heading= \
        args.debug, args.follow, False, False, False, args.fixed_path, False, args.small_terrain, True, args.show_im, args.server_mode, False, False, args.random_heading
