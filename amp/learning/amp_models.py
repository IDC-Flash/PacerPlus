...
class ModelAMPContinuous(ModelA2CContinuousLogStd):
    ...
    class Network(ModelA2CContinuousLogStd.Network):
        ...
        def get_dropout_mask(self,
            ...
            amp_smpl_keypoint_observation = env_cfg["env"].get("ampSMPLKeypointObs", False)
            try:
                assert (F/ steps == 161 or F / steps == 206 or F / steps == 205 or F / steps == 254 or F / steps == 197 or F / steps == 195 or F / steps == 188 or F / steps == 187)
            except:
                print(F/steps)
            ...
            num_joints = 19
            if not amp_smpl_keypoint_observation:
                dof_vel_offsets = 126 # 12 + 19 * 6
                if F / steps == 197: # Remove one joint
                    dof_vel_offsets = 120
                    num_joints = 18
                elif remove_neck:  # Remove two joints
                    dof_vel_offsets = 114
                    num_joints = 17
