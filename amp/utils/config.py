...
def load_cfg(args):
    ...
    if 'params' in cfg:
        cfg_train = {'params': cfg['params']}
        cfg.pop('params')

    if 'params' not in cfg and args.cfg_train is None:
        assert False, "No training parameters found in config file"
...
def get_args(benchmark=False):
    custom_parameters = [
        ...
        },
        {
            "name": "--video_id",
            "type": str,
            "default": "8424573439186068308_3460_000_3480_000",
        },
        {
            "name": "--show_im",
            "action": "store_true",
